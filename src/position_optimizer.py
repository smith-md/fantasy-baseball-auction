...
class PositionOptimizer:
    ...
    def _assign_players(self, df: pd.DataFrame, player_type: str):
        ...
        for _, player in df_sorted.iterrows():
            ...
            # Tier-based assignment (matches live draft assigner logic)
            ...
            if specific:
                # Prefer specific position with fewest remaining slots (most scarce)
            ...
            self.assignments.append({
                'player_id': player.get('player_id', _),
